...
var student1 = {
    ...
    age: 23,
    greet: function (country) { return "Welcome My name is ".concat(student1.name, ", I am ").concat(student1.age, " years old and I am from ").concat(country); }
};
var student2 = {
    name: "Milan Rajbanshi",
    age: 24,
    greet: function (country) { return "Welcome My name is ".concat(student2.name, ", I am ").concat(student2.age, " years old and I am from ").concat(country); }
};
